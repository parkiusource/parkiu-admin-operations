    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        ...
        <DialogFooter className="flex-col gap-2 sm:flex-row">
          {/* En móvil no habilitamos impresión (evita UX mala / popups) */}
          <Button
            type="button"
            onClick={handlePrint}
            className="hidden sm:inline-flex w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white order-1 sm:order-none"
          >
